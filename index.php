                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4"><span class="text-success">Our Guide</span><br>
                            Guide you to your Home!</h1><!-- FOR MORE PROJECTS visit: codeastro.com -->
            ...
            <div class="container">
                ...
                <div class="text-box-one">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-money-bag text-success flat-medium" aria-hidden="true"></i>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-virtual-reality text-success flat-medium" aria-hidden="true"></i>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-agent-avatar text-success flat-medium" aria-hidden="true"></i>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-map-pin text-success flat-medium" aria-hidden="true"></i>
                                    ...
                                    <div class="col-md-6 col-lg-4"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                ...
                                                <div class="price text-primary"><b>$<?php echo $row['13'];?> </b><span class="text-white"><?php echo $row['12'];?> Sq.ft</span></div>
                                            </div>
                                            <div class="featured-thumb-data shadow-one">
                                                ...
                                                <div class="bg-gray quantity px-4 pt-4">
                                                    <ul>
                                                        <li><span><?php echo $row['12'];?></span> Sq.ft</li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>If you decide to make an offer on a property, we will help you prepare a competitive offer and negotiate on your behalf. If you are selling a property, we will work with potential buyers to negotiate offers and ensure that all necessary documentation is in order.</p>
                        </div>
                    </div>
                </div>
            </div>
