                ...
                <div class="row">
                    <div class="col-lg-4 mb-5 bg-secondary">
                        <div class="contact-info">
                            <h3 class="mb-4 mt-4 text-white">Contact Us</h3>
							
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Address</h5>
                                        <span class="text-white">9 Gothatar, Kathmandu</span> <br>
										<span class="text-white">Paknajol, Kathmandu</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+977 984 1215288</span>
										<span class="text-white">+977 984 1234567</span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email</h5>
										<span class="d-table text-white">dippes10@gmail.com</span>
										<span class="text-white">fast@fast.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-12 col-lg-7">
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<h2 class="text-secondary double-down-line text-center mb-5">Interact with us!</h2>
								...
								<form class="w-100" action="#" method="post">
									<div class="row">
										<div class="row mb-4">
											...
											<div class="form-group col-lg-6">
												<input type="text" name="subject"  class="form-control" placeholder="Concern">
											</div>
											<div class="col-lg-12">
												<div class="form-group">
													<textarea name="message" class="form-control" rows="5" placeholder="Write Comments.."></textarea>
												</div>
											</div>
										</div>
										<button type="submit" value="send message" name="send" class="btn btn-success">Submit</button>
									</div>
								</form>
							</div>
						</div>
